...
| STAB-3 | Session reporting: position frozen in dashboard (`updatePosition` never called — no Movian player event wired), `invalid_json` on 204 responses, « Authentication without realm » noise | todo | normal | `stability` | `docs/missions/stability-3-session-reporting.md` |
